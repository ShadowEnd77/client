...
import a_3_12 from '/game_3/aud_3_12.mp3'
      ...
      payload: {
        ...
        dialogues: [
          ...
          },
          {
            ...
            voice: a_2_3,
            name: "Димка",
            text: "Знаешь, круто, что ты не ведёшься. Я бы один точно не решился отказаться."
          }
        ]
      }
    },
        ...
        dialogues: [
          {
            ...
            voice: a_4_12,
            name: "",
            text: "Азот начинает подниматься на  Крышу  и срывается. Он еле удерживается. В голове звучит голос:"
          },
          {
            image: i_7_2,
            voice: a_4_3,
        ...
        dialogues: [
          {
            ...
            voice: a_6_1,
            name: "Азот",
            text: "Быть смелым — это не значит делать опасные вещи. Это значит выбирать правильно, даже если тебя подталкивают."
          }
        ]
      }
    }
